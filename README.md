...
<html>
  <head>
    ...
    <title>GSCG-VR测试</title>
  </head>
  <body>
    <center><font color="red" size="8">GSCGVR-新世界&nbsp;加载中</font></center>
    <a-scene>

      <a-text value="Welcome to GSCG-VR" color="#FFC65D"
         position="-2 1 -3" scale="3 3 3"></a-text>

      <a-text value="First to the key!" color="#FFFFFF"
      ...
      <a-sphere position="-1 15 100" rotation="0 220 0" radius="30" src="./images/caidan-yellow.jpg"></a-sphere>
      <a-sphere position="1 200 -300" radius="150" src="./images/very-big-ball.jpg"></a-sphere>
      <a-sphere position="-1 1.25 -5" radius="1.25" src="./images/welcome-purple.jpg"></a-sphere>
      <a-sphere position="1 1.25 -5" radius="1.25" src="./images/welcome-blue(with yellow words).jpg"></a-sphere>
      <a-sphere position="3 1.25 -5" radius="1.25" src="./images/welcome-purple.jpg"></a-sphere>
      ...
      <a-sky src="./images/welcome-blue(with yellow words).jpg"></a-sky>
      <a-light
        type="directional"
        color="#FFF"
        intensity="0.5"
